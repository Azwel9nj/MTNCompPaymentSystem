                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.customer.view',[$transaction['to_user_id']])}}">
                                            {{ \App\CentralLogics\Helpers::get_user_info($transaction['from_user_id'])->f_name ?? '' }} {{\App\CentralLogics\Helpers::get_user_info($transaction['from_user_id'])->phone ?? ''}}
                                        </a>
                                    </td>
                                    <td>
                                        <a href="{{route('admin.customer.view',[$transaction['to_user_id']])}}">
                                            {{ \App\CentralLogics\Helpers::get_user_info($transaction['to_user_id'])->f_name ?? '' }} {{ \App\CentralLogics\Helpers::get_user_info($transaction['to_user_id'])->phone ?? '' }}
                                        </a>
                                    </td>
                                    <td>
                                        <span class="">
